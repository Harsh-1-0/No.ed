    ...
    <div className="min-h-screen font-tripSansBold">
      <nav className="flex items-center justify-between p-4 border-black border-b-8 mx-6 my-2 border-t-2 border-x-2">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-4 py-2 text-black bg-lime-300 font-bold border-black border-b-4 border-r-4 drop-shadow-md"
          >
            TRY OUT!
          </button>
        </div>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="relative flex flex-col items-center justify-center p-8 rounded-lg mb-16">
          ...
          <p className="mt-12">
            <span className="text-lime-500 text-left font-tripSansBold font-extrabold">
              *
            </span>{" "}
            pronounced {"Node"}
          </p>
        ...
        <div className="mb-16">
          <h2 className="text-4xl font-bold mb-6 font-tripSansBold justify-center align-middle text-center">
            OUR MAGIC
          </h2>
        ...
        <div className="bg-purple-100 p-6 rounded-sm font-tripSansMono font-semibold mb-16">
          <p className="text-7xl">
            No.ed is an intelligent and interactive platform designed to help
            learners and professionals build their careers through a seamless
